    ...
    <div className="space-y-6">
      ...
      {editing ? (
        <Card>
          ...
          <div className="mt-4 flex gap-2">
            <PrimaryButton onClick={onSaveEdit} disabled={savingEdit}>
      ...
      <Card>
        ...
        {showCreateMerchant ? (
          <div className="mt-4 flex flex-col gap-2 sm:flex-row sm:items-end">
            ...
            <PrimaryButton onClick={onCreateMerchant} disabled={creatingMerchant}>
            ...
            <tbody className="divide-y divide-slate-100">
              {(merchantsData?.merchants ?? []).map((merchant) => (
                <tr key={merchant.id}>
                  ...
                  <Td>
                    <Link href={`/app/merchants/${merchant.id}`} className="font-medium text-blue-600 hover:text-blue-700">
                      View
                    </Link>
                  </Td>
                </tr>
      ...
      <Card>
        <div className="flex items-center justify-between">
          ...
          <Link href={`/app/brand-it?scope=organisation&scopeId=${id}`} className="text-sm font-medium text-blue-600 hover:text-blue-700">
